...
echo "export WP_BACKUP_INCLUDE_ONLY_FOLDERS=\"uploads,languages\""
echo "export BACKUP_DEST=\"~\""
echo "export BACKUP_TAG=\"production\"  # Optional"
...
echo "~/$(date +'%Y-%m-%d').production.wp-content.zip  # With BACKUP_TAG set"
...
echo ""
echo "5. Customize backup folders, destination, and tag:"
echo "   export WP_BACKUP_INCLUDE_ONLY_FOLDERS=\"uploads,themes,plugins\""
echo "   export BACKUP_DEST=\"/custom/path\""
echo "   export BACKUP_TAG=\"staging\""
